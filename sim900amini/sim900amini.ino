...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+918610889171\"\r"); // Replace x with mobile number
  delay(1000);
...
void MakeCall()
{
  mySerial.println("ATD+918610889171;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
